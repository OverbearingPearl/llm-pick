...
(defun llm-pick-align--edit-distance (s1 s2)
...
(defun llm-pick-align--similarity (a b)
...
decreasing score."
  (sort (mapcar (lambda (candidate)
                  (cons (cdr candidate)
                        (llm-pick-align--similarity normalized (cdr candidate))))
                canonicals)
